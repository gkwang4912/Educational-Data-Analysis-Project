document.addEventListener('DOMContentLoaded', async () => {
    const schoolDataPath = 'https://loadanalyze-215342948362.asia-east1.run.app/api/result/1_學校分析結果';
    const exerciseDataPath = 'https://loadanalyze-215342948362.asia-east1.run.app/api/result/2_練習題';
    ...
    try {
        ...
        if (container) {
            ...
            errorP.textContent = `載入儀表板資料時發生錯誤: ${error.message}. 請檢查 API 端點是否可存取且格式正確。同時確認瀏覽器主控台以獲取更多資訊。`;
